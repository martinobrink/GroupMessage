...
namespace GroupMessage
{
	...
	{
		//const identifiers used for storing/retrieving preferences
		public const string PREF_PHONE_NUMBER = "PhoneNumber";
		public const string PREF_LAST_MESSAGE = "LastMessage";
